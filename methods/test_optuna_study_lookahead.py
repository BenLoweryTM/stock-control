...
def run_study(
    ...
    def convergence_tracking_callback(study: optuna.Study, trial: optuna.Trial) -> None:
        ...
        if count == 2:
            ...
            print(f"[Convergence] Parameter warehouse_order_up_to={param_value} suggested {count} times")
...
if __name__ == "__main__":
    ...
    if args.instance_idx is not None:
        with open("../parameters/instances.pkl", "rb") as f:
            ...
            print(f"Loaded instance {args.instance_idx} from ./parameters/test_instances.pkl")
    else:
        raise ValueError("Please specify --instance-idx to select an instance from parameters/test_instances.pkl")
